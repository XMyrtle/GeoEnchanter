...
{
    class GeoArmorShieldAbility
    {
        private static readonly string AbilityName = "GeoArmorShieldAbility";
        public static void Configure()
        {
            var Ability = AbilityConfigurator.New(name: AbilityName, guid: Guids.GeoArmorShieldAbility);
            ...
            Ability.AddAbilityEffectRunAction(actions: ActionsBuilder.New()
                                                     .ApplyBuffPermanent(buff: Guids.GeoArmorShieldBuff,
                                                                         asChild: true,
                                                                         isFromSpell: false,
                                                                         ...
                                                                         toCaster: false)
                                                    .AcceptBurn(value: 1));
            Ability.SetDisplayName("GeoArmorShield_Name");
            Ability.SetDescription("GeoArmor_Desc");
            Ability.SetIcon(Icons.GeoKineticistIconRef.GeoArmor);
