...
{
    class GeoArmorArmorEffectFeature
    {
        private static readonly string FeatureName = "GeoArmorArmorEffectFeature";
        public static void Configure()
        {
            var Feature = FeatureConfigurator.New(name: FeatureName, guid: Guids.GeoArmorArmorEffectFeature);
            ...
            Feature.SetDisplayName("GeoArmorArmor_Name");
            Feature.SetDescription("GeoArmor_Desc");
            Feature.SetIcon(Icons.GeoKineticistIconRef.GeoArmorArmor);
            Feature.SetRanks(1);
        ...
        private static ShroudOfWater Shroud(string UpgradeFeature)
        {
            ...
            ShroudOfWaterComponent.Descriptor = ModifierDescriptor.Armor;
